  ...
  <!-- brand -->
    ...
    <nav class="navigation">
      <ul class="list-unstyled">
        <li class="@yield('home')"><a href="{{url('/home')}}"><i class="zmdi zmdi-view-dashboard"></i> <span class="nav-label">หน้าแรก</span></a>
        </li>
        <li class="has-submenu @yield('body')">
          ...
          <li><a href="{{url('/outofstock')}}">สินค้าใกล้หมด
            <span class="badge bg-danger"><?php $amount = DB::table('products')->where('amount','<=',10)->get(); ?> {{count($amount)}} 
            </span></a>
          </li>
          <li><a href="{{url('/bestproduct')}}">สินค้าขายดี<span class="badge bg-success">10</span>
          </li></a>
        ...
        <li class="has-submenu">
          <a href="{{url('buystore')}}">
            ...
            <span class="nav-label">สั่งซื้อสินค้า</span>
          </a>
     <!-- <ul class="list-unstyled">
    ...
    @endif
     ...
     <!-- Search -->
      <input name="name" id="autocomplete" placeholder="Search" class="form-control">
    </div>
    </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6" id="outputbox">
